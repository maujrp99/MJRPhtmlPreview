...
1. **Grounding**: Load project context via `mjrp-onboarding-protocol.md` if not already loaded.
...
2. **Regression Check**: Run `mjrp-regression-protocol.md` for the affected area.
