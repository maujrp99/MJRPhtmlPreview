...
- **Debug triggers ADR**: `mjrp-debug-protocol.md` §2 (fix requires Core Pattern change → ADR first)
- **Architecture compliance**: `mjrp-code-quality-assessment-protocol.md`
