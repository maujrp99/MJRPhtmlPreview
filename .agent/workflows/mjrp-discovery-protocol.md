---
description: Discovery Protocol — Product discovery and backlog definition using mjrp-product-designer and mjrp-ba-scrum-master skills.
---
...
- **`mjrp-ba-scrum-master`**: Translates the validated idea into actionable, INVEST-compliant user stories in the backlog.
...
### Phase 2: Refine & Document (`mjrp-ba-scrum-master`)
