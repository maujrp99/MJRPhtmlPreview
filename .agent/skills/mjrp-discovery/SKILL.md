...
name: mjrp-discovery
description: >
  MJRP Discovery Protocol for product discovery and backlog definition using product-designer and mjrp-ba-sm.
  Trigger: discovery, product discovery, new feature idea, validate idea, define backlog, descoberta, nova funcionalidade.
---
...
- **`mjrp-product-designer`**: Challenges assumptions, focuses on user value, viability, and usability constraints (Marty Cagan's methodology).
- **`mjrp-mjrp-ba-sm`**: Translates the validated idea into actionable, INVEST-compliant user stories in the backlog.

## 3. Workflow Steps

### Phase 1: Empathize & Ideate (`mjrp-product-designer`)
...
### Phase 2: Refine & Document (`mjrp-mjrp-ba-sm`)
...
- The flow proceeds to `.agent/workflows/mjrp-design-protocol.md`.
