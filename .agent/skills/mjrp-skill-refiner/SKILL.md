...
```bash
python /path/to/MJRP_ai_skills/skill_packages_Antigravity/scripts/package_dual.py <skill-folder-path>
```

To find the correct script path, look for `package_dual.py` inside
`MJRP_ai_skills/skill_packages_Antigravity/scripts/` in the mounted workspace. This script
