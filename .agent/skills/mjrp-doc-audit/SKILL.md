...
name: mjrp-doc-audit
description: >
  MJRP Documentation Audit Protocol for verifying that spec documents match the code across all SpecKit artifacts.
  Trigger: documentation audit, audit docs, docs out of sync, check documentation, auditoria de documentacao.
---
