...
name: mjrp-adr
description: >
  MJRP Architecture Decision Record Protocol for creating and managing ADRs documenting significant architecture choices.
  Trigger: ADR, architecture decision, create ADR, write ADR, document this decision, decisao arquitetural.
---
...
Use the full template from `MJRP_templates/adr_template.md`. Minimum fields:
...
- **Full ADR template**: `MJRP_templates/adr_template.md`
- **Debug triggers ADR**: `mjrp-debug` §2 (fix requires Core Pattern change → ADR first)
- **Architecture compliance**: `mjrp-code-quality`
- **Post-ADR doc sync**: `mjrp-documentation-audit-protocol.md`
