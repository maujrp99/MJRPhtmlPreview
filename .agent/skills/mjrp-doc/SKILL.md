...
name: mjrp-doc
description: >
  MJRP Documentation Protocol post-implementation checklist ensuring all spec artifacts and docs are updated after coding.
  Trigger: documentation protocol, update docs, post-implementation, documentation checklist, atualizar documentacao.
---
...
- **Periodic Audit**: Run `mjrp-documentation-audit-protocol.md` monthly or when instructed.
