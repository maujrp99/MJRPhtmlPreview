---
name: mjrp-regression
description: >
  MJRP Regression Protocol to ensure new changes do not break existing functionality. Runs build and targeted checks.
  Trigger: regression, regression test, run regression, check for regressions, verify changes, teste de regressao.
---
