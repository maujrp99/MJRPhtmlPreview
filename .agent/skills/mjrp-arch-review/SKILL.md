---
name: mjrp-arch-review
description: >
  MJRP Architecture Review Protocol for full system review using system-architect before milestones or when drift is suspected.
  Trigger: architecture review, review architecture, architectural drift, milestone review, revisar arquitetura.
---
...
| New architectural decision needed | → `mjrp-adr` (ADR) |
...
- **ADR (post-decision record)**: `mjrp-adr`
- **Doc-code sync**: `mjrp-documentation-audit-protocol.md`
- **Code quality scan**: `mjrp-code-quality`
- **SDD integration**: Run before `mjrp-sdd-specify` when starting a new milestone
