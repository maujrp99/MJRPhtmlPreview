---
name: mjrp-code-quality
description: >
  MJRP Code Quality Assessment Protocol with metrics, stress tests, and technical debt update. Run end of sprint.
  Trigger: code quality, quality assessment, assess quality, check quality, tech debt scan, avaliar qualidade, code audit.
---
...
After the assessment, update `docs/TECHNICAL_DEBT.md` (use template from `MJRP_templates/technical_debt.md`):
...
4. **Missing Tests**: Cross-reference with `mjrp-test-audit` results
...
- **Technical Debt template**: `MJRP_templates/technical_debt.md`
- **Test coverage gaps**: `mjrp-test-audit`
- **ADRs for pattern changes**: `mjrp-architecture-decision-protocol.md`
