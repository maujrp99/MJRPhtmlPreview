---
name: mjrp-test-audit
description: >
  MJRP Test Suite Audit Protocol for auditing coverage gaps, deprecated patterns, flakiness, and regression checklist sync.
  Trigger: test audit, audit tests, test coverage, check test suite, test health, auditoria de testes, coverage audit.
---
...
- **Regression Checklist (modular)**: `mjrp-regression`
- **QA Strategy**: QA Engineer skill
- **Code Quality**: `mjrp-code-quality`
