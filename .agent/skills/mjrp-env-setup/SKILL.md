...
name: mjrp-env-setup
description: >
  MJRP Environment Setup Protocol for remote repo, dependencies, linting, CI/CD, and external services after scaffolding.
  Trigger: environment setup, setup environment, configure environment, setup repo, configurar ambiente, project setup.
---
